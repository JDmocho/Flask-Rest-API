...
@pytest.mark.parametrize(
    'data,missing_field',
    [
        ({'username': 'test987', 'password': '123456'}, 'email'),
        ({'username': 'test987', 'email': 'test987@gmail.com'}, 'password'),
        ({'password': '123456', 'email': 'test987@gmail.com'}, 'username'),
    ]
)
...
def test_get_current_user(client, user, token):
    ...
    assert 'create_date' in response_data['data']
